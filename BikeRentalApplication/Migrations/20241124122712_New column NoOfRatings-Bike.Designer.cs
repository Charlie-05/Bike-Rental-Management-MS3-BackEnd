...
namespace BikeRentalApplication.Migrations
{
    ...
    [Migration("20241124122712_New column NoOfRatings-Bike")]
    partial class NewcolumnNoOfRatingsBike
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BikeRentalApplication.Entities.Brand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BikeRentalApplication.Entities.Bike", b =>
                {
                    b.HasOne("BikeRentalApplication.Entities.Brand", "Brand")
                        .WithMany("Bikes")
