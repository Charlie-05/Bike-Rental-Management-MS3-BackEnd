...
namespace BikeRentalApplication.Migrations
{
    ...
    [Migration("20241104120249_Initial")]
            ...
            modelBuilder.Entity("BikeRentalApplication.Entities.RentalRequest", b =>
                {
                    ...
                    b.HasOne("BikeRentalApplication.Entities.RentalRecord", "RentalRecord")
                        .WithOne("RentalRequest")
                        .HasForeignKey("BikeRentalApplication.Entities.RentalRequest", "RentalRecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
